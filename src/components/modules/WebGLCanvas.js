...
export default function WebGLCanvas() {
  ...
  const main = async () => {
    ...
    //////////////////////////////////////////////
    // load shaders
    const vertex_shader_source = await fetch(canvas.current.dataset.vert).then(r => r.text());
    console.log(vertex_shader_source);

    const fragment_shader_source = await fetch(canvas.current.dataset.frag).then(r => r.text());
